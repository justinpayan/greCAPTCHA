You are helping select a paper for a controlled study. Attached is a manuscript written by {{PARTICIPANT_NAME}}, one of its authors. I need five candidate papers by other people that this person is unlikely to have read, all of them OUT-FIELD for them.
...
4. Why it is OUT-FIELD for this person specifically, referring to the profile from Step 1 rather than to the field in general.
